  ...
  buduj({ t, total }) {
    const scena = [
      ...
      { obiekt: 'light_bulb_3d', x: 830, y: 570, skala: 600, obrot: 9, skad: 'prawo',
        start: t(4, 0.05), koniec: t(4, 0.95), dokad: 'prawo' },
    ...
    const wzor = [
      { tekst: '1 ZDJĘCIE = 1 HISTORIA', y: 940, maly: true, a: t(2, 0.40), b: t(4, 0.60) },
...
//
// ОГРАНИЧЕНИЕ, которое видно на экране: в папке `grafika/obiekty` нет ни мяча,
// ни ничего спортивного — только офисные эмодзи. Поэтому предметная часть
// здесь слабее, чем у Museo, и вес держат три карточки живого видео (спорт,
// бег). Мяч нужен как PNG — промпт для него лежит в утреннем плане.
const ESPANOLA = {
  klucz: 'demo-espanola',
