...
// Сколько часов без поста считаем нормой. Щадящий режим даёт один пост в
// сутки, обычный — два, планировщик GitHub опаздывает на десятки минут.
// 30 часов покрывают любой законный разрыв и ловят настоящую остановку.
const LIMIT_GODZIN = 30;
