...
const SCENARIUSZE = [
  ...
  },
  {
    ...
    czesci: [
      ...
      { rola: 'hak', tekst: 'I na tym rozmowa się kończy.', szukaj: 'person disappointed looking at phone', pauza: 0.44 },
      { rola: 'punkt', numer: 1, tytul: 'najpierw cel', tekst: 'Najpierw jedno pytanie o cel.', szukaj: 'two people talking business meeting', pauza: 0.30 },
      { rola: 'punkt', numer: 2, tytul: 'widełki', tekst: 'Potem widełki. Nie cisza.', szukaj: 'calculator price numbers desk', pauza: 0.30 },
      { rola: 'punkt', numer: 3, tytul: 'termin', tekst: 'Na koniec konkretny termin rozmowy.', szukaj: 'calendar appointment phone hand', pauza: 0.28 },
  ...
  },
  {
    ...
    czesci: [
      ...
      { rola: 'punkt', numer: 1, tytul: 'godziny', tekst: 'Aktualne godziny. To pierwsza rzecz.', szukaj: 'open sign shop door hours', pauza: 0.30 },
      { rola: 'punkt', numer: 2, tytul: 'zdjęcia', tekst: 'Dziesięć zdjęć z ostatniego miesiąca.', szukaj: 'person photographing shop interior phone', pauza: 0.30 },
      ...
      { rola: 'zaplata', tekst: 'Ludzie szukają w Google, zanim wejdą na Instagram.', szukaj: 'person searching phone street city', pauza: 0.32 },
  ...
  },
  {
    ...
    czesci: [
      ...
      { rola: 'punkt', numer: 2, tytul: 'po co', tekst: 'Powiedz, po co ci ona.', szukaj: 'two people conversation cafe honest', pauza: 0.30 },
      ...
      { rola: 'cta', tekst: 'Wyślij to komuś, kto ma zero opinii.', szukaj: 'friends sharing phone screen laughing', pauza: 0.20 },
    ],
  },
  {
    ...
    czesci: [
      ...
      { rola: 'hak', tekst: 'Liczy się, gdzie klient cię szuka.', szukaj: 'person searching on laptop cafe', pauza: 0.44 },
      ...
      { rola: 'punkt', numer: 3, tytul: 'zwykle oba', tekst: 'Zwykle jest jedno i drugie.', szukaj: 'business owner laptop phone shop', pauza: 0.28 },
      { rola: 'zaplata', tekst: 'Instagram wynajmujesz. Stronę masz.', szukaj: 'keys handing over apartment door', pauza: 0.34 },
      { rola: 'cta', tekst: 'Napisz, gdzie klienci znajdują ciebie.', szukaj: 'woman typing comment phone street', pauza: 0.20 },
    ],
  },
  {
    ...
    czesci: [
      ...
      { rola: 'punkt', numer: 3, tytul: 'tło', tekst: 'Zabierz ze stołu wszystko inne.', szukaj: 'clean table setting minimal restaurant', pauza: 0.28 },
      { rola: 'zaplata', tekst: 'Menu je się oczami. Najpierw w telefonie.', szukaj: 'people ordering food looking at phone', pauza: 0.32 },
      { rola: 'cta', tekst: 'Zapisz i zrób tak przy następnym daniu.', szukaj: 'chef plating dish kitchen', pauza: 0.20 },
    ],
  },
  {
    ...
    czesci: [
      ...
      { rola: 'zaplata', tekst: 'Kupujemy u ludzi, których widzieliśmy przy robocie.', szukaj: 'customer shaking hands with mechanic', pauza: 0.32 },
      { rola: 'cta', tekst: 'Wyślij komuś, kto nie ma o czym nagrywać.', szukaj: 'person sharing video phone workshop', pauza: 0.20 },
    ],
  },
  {
    ...
    czesci: [
      ...
      { rola: 'punkt', numer: 3, tytul: 'kto decyduje', tekst: 'Scenariusz i tak pisze człowiek.', szukaj: 'person writing notes storyboard desk', pauza: 0.28 },
      { rola: 'zaplata', tekst: 'Narzędzie skraca robotę. Nie zastępuje myślenia.', szukaj: 'hands typing keyboard focused work', pauza: 0.32 },
      { rola: 'cta', tekst: 'Napisz, co chcesz zobaczyć w następnej.', szukaj: 'person commenting phone evening', pauza: 0.20 },
    ],
  },
  {
    ...
    czesci: [
      ...
      { rola: 'punkt', numer: 2, tytul: 'dla kogo', tekst: 'Napisz, dla kogo to jest.', szukaj: 'target customer group people street', pauza: 0.30 },
      { rola: 'punkt', numer: 3, tytul: 'do kiedy', tekst: 'Daj termin. Konkretną datę.', szukaj: 'hourglass time running out desk', pauza: 0.28 },
      { rola: 'zaplata', tekst: 'Bez tego rabat czyta się jak desperacja.', szukaj: 'empty store no customers sale', pauza: 0.32 },
      { rola: 'cta', tekst: 'Zapisz przed następną promocją.', szukaj: 'hand saving note phone screen', pauza: 0.20 },
    ],
  },
  {
    ...
    czesci: [
      ...
      { rola: 'zaplata', tekst: 'Kod to najkrótsza część tej roboty.', szukaj: 'developer coding screen fast typing', pauza: 0.32 },
      { rola: 'cta', tekst: 'Napisz, na czym stoi twoja strona.', szukaj: 'hands typing comment phone office', pauza: 0.20 },
    ],
  },
];
